...
namespace Arcor2.ClientSdk.ClientServices.Extensions {
    internal static class ListExtensions {
        ...
        /// </summary>
        /// <typeparam name="TManager">The type of <see cref="LockableArcor2ObjectManager"/>.</typeparam>
        ...
        /// </example>
        public static IList<TManager> UpdateListOfLockableArcor2Objects<TManager, TObject>(this IList<TManager>? managers, IList<TObject> newObjects, 
            Func<TObject, string> id, Action<TManager, TObject> update, Func<TObject, TManager> creation)
            where TManager : LockableArcor2ObjectManager {
