...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RenameActionRequest : IEquatable<RenameActionRequest>, IValidatableObject
    {
        ...
        public RenameActionRequest(int id = default, string request = default, RenameActionRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as RenameActionRequest);
        }
