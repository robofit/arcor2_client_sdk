...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class NewObjectTypeResponse : IEquatable<NewObjectTypeResponse>, IValidatableObject
    {
        ...
        public NewObjectTypeResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as NewObjectTypeResponse);
        }
