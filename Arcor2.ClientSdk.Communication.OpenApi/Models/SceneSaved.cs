...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// SceneSaved()
    /// </summary>
    [DataContract(Name = "SceneSaved")]
    public partial class SceneSaved : IEquatable<SceneSaved>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneSaved" /> class.
        /// </summary>
        [JsonConstructor]
        protected SceneSaved() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneSaved" /> class.
        /// </summary>
        ...
        public SceneSaved(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for SceneSaved and cannot be null");
            }
            this.Event = varEvent;
        ...
        {
            return this.Equals(input as SceneSaved);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SceneSaved input)
        {
            if (input == null)
            {
                return false;
