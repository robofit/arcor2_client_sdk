...
{
    /// <summary>
    /// Notification(data: Optional[arcor2.data.events.Notification.Data] &#x3D; None)
    /// </summary>
    ...
    public partial class Notification : IEquatable<Notification>, IValidatableObject
    {
        ...
        public Notification(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), NotificationData data = default(NotificationData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for Notification and cannot be null");
            }
            this.Event = varEvent;
