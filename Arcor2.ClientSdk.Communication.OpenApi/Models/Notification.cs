...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class Notification : IEquatable<Notification>, IValidatableObject
    {
        ...
        public Notification(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, NotificationData data = default)
        {
        ...
        {
            return Equals(input as Notification);
        }
