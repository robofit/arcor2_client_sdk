...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RemoveFromSceneRequest : IEquatable<RemoveFromSceneRequest>, IValidatableObject
    {
        ...
        public RemoveFromSceneRequest(int id = default, string request = default, RemoveFromSceneRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as RemoveFromSceneRequest);
        }
