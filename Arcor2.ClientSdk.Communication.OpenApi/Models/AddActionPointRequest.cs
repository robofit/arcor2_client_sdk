...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddActionPointRequest : IEquatable<AddActionPointRequest>, IValidatableObject
    {
        ...
        public AddActionPointRequest(int id = default, string request = default, AddActionPointRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as AddActionPointRequest);
        }
