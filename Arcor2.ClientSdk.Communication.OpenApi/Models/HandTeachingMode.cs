...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class HandTeachingMode : IEquatable<HandTeachingMode>, IValidatableObject
    {
        ...
        public HandTeachingMode(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, HandTeachingModeData data = default)
        {
        ...
        {
            return Equals(input as HandTeachingMode);
        }
