...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddObjectToSceneRequest : IEquatable<AddObjectToSceneRequest>, IValidatableObject
    {
        ...
        public AddObjectToSceneRequest(int id = default, string request = default, AddObjectToSceneRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as AddObjectToSceneRequest);
        }
