...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class Response : IEquatable<Response>, IValidatableObject
    {
        ...
        public Response(int id = 0, string varResponse = default, bool result = true, List<string> messages = default)
        {
        ...
        public bool Equals(Response input)
        {
            ...
            return 
                ...
                (
                    VarResponse == input.VarResponse ||
                    (VarResponse != null &&
                    VarResponse.Equals(input.VarResponse))
                ) && 
                (
                    Result == input.Result ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (VarResponse != null)
                {
                    hashCode = hashCode * 59 + VarResponse.GetHashCode();
                }
