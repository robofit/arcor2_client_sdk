...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class Response : IEquatable<Response>, IValidatableObject
    {
        ...
        /// <param name="varResponse">varResponse (required).</param>
        /// <param name="result">result (default to true).</param>
        /// <param name="messages">messages.</param>
        public Response(int id = 0, string varResponse = default(string), bool result = true, List<string> messages = default(List<string>))
        {
            // to ensure "varResponse" is required (not null)
            if (varResponse == null)
            {
                throw new ArgumentNullException("varResponse is a required property for Response and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarResponse: ").Append(VarResponse).Append("\n");
        ...
        public bool Equals(Response input)
        {
            ...
            return 
                ...
                (
                    this.VarResponse == input.VarResponse ||
                    (this.VarResponse != null &&
                    this.VarResponse.Equals(input.VarResponse))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.VarResponse.GetHashCode();
                }
