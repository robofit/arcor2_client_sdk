...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class LogicItemChanged : IEquatable<LogicItemChanged>, IValidatableObject
    {
        ...
        public LogicItemChanged(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, LogicItem data = default)
        {
        ...
        {
            return Equals(input as LogicItemChanged);
        }
