...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RenameProjectResponse : IEquatable<RenameProjectResponse>, IValidatableObject
    {
        ...
        public RenameProjectResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as RenameProjectResponse);
        }
