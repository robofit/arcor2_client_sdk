...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class DeletePackageResponse : IEquatable<DeletePackageResponse>, IValidatableObject
    {
        ...
        public DeletePackageResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as DeletePackageResponse);
        }
