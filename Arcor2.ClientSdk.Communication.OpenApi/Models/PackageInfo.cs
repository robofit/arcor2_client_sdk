...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class PackageInfo : IEquatable<PackageInfo>, IValidatableObject
    {
        ...
        public PackageInfo(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, PackageInfoData data = default)
        {
        ...
        {
            return Equals(input as PackageInfo);
        }
