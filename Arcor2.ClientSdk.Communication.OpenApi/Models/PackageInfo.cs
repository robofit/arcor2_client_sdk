...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class PackageInfo : IEquatable<PackageInfo>, IValidatableObject
    {
        ...
        public PackageInfo(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), PackageInfoData data = default(PackageInfoData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for PackageInfo and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for PackageInfo and cannot be null");
            }
            this.Data = data;
