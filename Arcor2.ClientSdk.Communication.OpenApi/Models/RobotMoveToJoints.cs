...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RobotMoveToJoints : IEquatable<RobotMoveToJoints>, IValidatableObject
    {
        ...
        public RobotMoveToJoints(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, RobotMoveToJointsData data = default)
        {
        ...
        {
            return Equals(input as RobotMoveToJoints);
        }
