...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class DeleteOverrideResponse : IEquatable<DeleteOverrideResponse>, IValidatableObject
    {
        ...
        public DeleteOverrideResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as DeleteOverrideResponse);
        }
