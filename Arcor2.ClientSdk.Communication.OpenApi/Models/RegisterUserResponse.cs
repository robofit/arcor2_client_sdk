...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RegisterUserResponse : IEquatable<RegisterUserResponse>, IValidatableObject
    {
        ...
        public RegisterUserResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
            // to ensure "response" is required (not null)
            if (response == null)
            {
                throw new ArgumentNullException("response is a required property for RegisterUserResponse and cannot be null");
            }
            Response = response;
            Id = id;
            Result = result;
        ...
        {
            return Equals(input as RegisterUserResponse);
        }
