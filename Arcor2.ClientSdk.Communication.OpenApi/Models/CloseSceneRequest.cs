...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CloseSceneRequest : IEquatable<CloseSceneRequest>, IValidatableObject
    {
        ...
        public CloseSceneRequest(int id = default, string request = default, CloseSceneRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as CloseSceneRequest);
        }
