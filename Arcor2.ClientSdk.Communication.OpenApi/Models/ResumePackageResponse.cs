...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ResumePackageResponse : IEquatable<ResumePackageResponse>, IValidatableObject
    {
        ...
        public ResumePackageResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as ResumePackageResponse);
        }
