...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ForwardKinematicsRequestArgs : IEquatable<ForwardKinematicsRequestArgs>, IValidatableObject
    {
        ...
        public ForwardKinematicsRequestArgs(string robotId = default(string), string endEffectorId = default(string), List<Joint> joints = default(List<Joint>), string armId = default(string))
        {
        ...
        {
            return this.Equals(input as ForwardKinematicsRequestArgs);
        }
