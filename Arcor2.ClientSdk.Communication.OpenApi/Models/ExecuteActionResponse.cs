...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ExecuteActionResponse : IEquatable<ExecuteActionResponse>, IValidatableObject
    {
        ...
        public ExecuteActionResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as ExecuteActionResponse);
        }
