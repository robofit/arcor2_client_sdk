...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "ActionExecution")]
    public partial class ActionExecution : IEquatable<ActionExecution>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionExecution" /> class.
        /// </summary>
        ...
        public ActionExecution(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), ActionExecutionData data = default(ActionExecutionData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for ActionExecution and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ActionExecution and cannot be null");
            }
            this.Data = data;
        ...
        {
            return this.Equals(input as ActionExecution);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ActionExecution input)
        {
            if (input == null)
            {
                return false;
