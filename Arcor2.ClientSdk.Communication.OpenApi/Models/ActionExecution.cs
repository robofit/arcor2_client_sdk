...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionExecution : IEquatable<ActionExecution>, IValidatableObject
    {
        ...
        public ActionExecution(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ActionExecutionData data = default)
        {
        ...
        {
            return Equals(input as ActionExecution);
        }
