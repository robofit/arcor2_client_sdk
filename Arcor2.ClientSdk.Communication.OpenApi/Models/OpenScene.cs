...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class OpenScene : IEquatable<OpenScene>, IValidatableObject
    {
        ...
        public OpenScene(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), OpenSceneData data = default(OpenSceneData))
        {
        ...
        {
            return this.Equals(input as OpenScene);
        }
