...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class NewProjectRequest : IEquatable<NewProjectRequest>, IValidatableObject
    {
        ...
        public NewProjectRequest(int id = default, string request = default, NewProjectRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as NewProjectRequest);
        }
