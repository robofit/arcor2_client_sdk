...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddActionPointResponse : IEquatable<AddActionPointResponse>, IValidatableObject
    {
        ...
        public AddActionPointResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as AddActionPointResponse);
        }
