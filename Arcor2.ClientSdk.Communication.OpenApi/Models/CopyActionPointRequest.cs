...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CopyActionPointRequest : IEquatable<CopyActionPointRequest>, IValidatableObject
    {
        ...
        public CopyActionPointRequest(int id = default, string request = default, CopyActionPointRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as CopyActionPointRequest);
        }
