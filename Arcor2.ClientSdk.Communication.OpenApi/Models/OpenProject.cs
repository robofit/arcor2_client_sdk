...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class OpenProject : IEquatable<OpenProject>, IValidatableObject
    {
        ...
        public OpenProject(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, OpenProjectData data = default)
        {
        ...
        {
            return Equals(input as OpenProject);
        }
