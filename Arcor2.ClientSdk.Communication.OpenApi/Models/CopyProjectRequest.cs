...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CopyProjectRequest : IEquatable<CopyProjectRequest>, IValidatableObject
    {
        ...
        public CopyProjectRequest(int id = default, string request = default, CopyProjectRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as CopyProjectRequest);
        }
