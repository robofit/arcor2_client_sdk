...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class PackageState : IEquatable<PackageState>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageState" /> class.
        /// </summary>
        ...
        public PackageState(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), PackageStateData data = default(PackageStateData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for PackageState and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for PackageState and cannot be null");
            }
            this.Data = data;
        ...
        {
            return this.Equals(input as PackageState);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PackageState input)
        {
            if (input == null)
            {
                return false;
