...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class PackageState : IEquatable<PackageState>, IValidatableObject
    {
        ...
        public PackageState(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, PackageStateData data = default)
        {
        ...
        {
            return Equals(input as PackageState);
        }
