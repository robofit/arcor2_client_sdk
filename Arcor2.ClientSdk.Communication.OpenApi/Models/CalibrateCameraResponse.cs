...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CalibrateCameraResponse : IEquatable<CalibrateCameraResponse>, IValidatableObject
    {
        ...
        public CalibrateCameraResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as CalibrateCameraResponse);
        }
