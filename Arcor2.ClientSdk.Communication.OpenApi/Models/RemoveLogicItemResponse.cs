...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RemoveLogicItemResponse : IEquatable<RemoveLogicItemResponse>, IValidatableObject
    {
        ...
        public RemoveLogicItemResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as RemoveLogicItemResponse);
        }
