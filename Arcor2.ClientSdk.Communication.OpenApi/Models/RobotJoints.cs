...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RobotJoints : IEquatable<RobotJoints>, IValidatableObject
    {
        ...
        public RobotJoints(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), RobotJointsData data = default(RobotJointsData))
        {
        ...
        {
            return this.Equals(input as RobotJoints);
        }
