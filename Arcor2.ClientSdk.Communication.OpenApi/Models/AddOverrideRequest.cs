...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddOverrideRequest : IEquatable<AddOverrideRequest>, IValidatableObject
    {
        ...
        public AddOverrideRequest(int id = default, string request = default, AddOverrideRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as AddOverrideRequest);
        }
