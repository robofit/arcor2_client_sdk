...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "SceneState")]
    public partial class SceneState : IEquatable<SceneState>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        public SceneState(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), SceneStateData data = default(SceneStateData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for SceneState and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for SceneState and cannot be null");
            }
            this.Data = data;
        ...
        {
            return this.Equals(input as SceneState);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SceneState input)
        {
            if (input == null)
            {
                return false;
