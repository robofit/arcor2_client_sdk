...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class OverrideUpdated : IEquatable<OverrideUpdated>, IValidatableObject
    {
        ...
        public OverrideUpdated(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, Parameter data = default)
        {
        ...
        {
            return Equals(input as OverrideUpdated);
        }
