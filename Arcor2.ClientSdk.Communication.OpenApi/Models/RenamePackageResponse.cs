...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RenamePackageResponse : IEquatable<RenamePackageResponse>, IValidatableObject
    {
        ...
        public RenamePackageResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as RenamePackageResponse);
        }
