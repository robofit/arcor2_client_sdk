...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RemoveFromSceneResponse : IEquatable<RemoveFromSceneResponse>, IValidatableObject
    {
        ...
        public RemoveFromSceneResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as RemoveFromSceneResponse);
        }
