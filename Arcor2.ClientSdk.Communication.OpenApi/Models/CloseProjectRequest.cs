...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CloseProjectRequest : IEquatable<CloseProjectRequest>, IValidatableObject
    {
        ...
        public CloseProjectRequest(int id = default, string request = default, CloseProjectRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as CloseProjectRequest);
        }
