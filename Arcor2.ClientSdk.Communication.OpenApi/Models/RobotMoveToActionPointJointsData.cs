...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RobotMoveToActionPointJointsData : IEquatable<RobotMoveToActionPointJointsData>, IValidatableObject
    {
        ...
        public RobotMoveToActionPointJointsData(MoveEventTypeEnum moveEventType = default(MoveEventTypeEnum), string robotId = default(string), string jointsId = default(string), bool safe = default(bool), string message = default(string), string armId = default(string))
        {
        ...
        {
            return this.Equals(input as RobotMoveToActionPointJointsData);
        }
