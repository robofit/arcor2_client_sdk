...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RemoveActionPointRequest : IEquatable<RemoveActionPointRequest>, IValidatableObject
    {
        ...
        public RemoveActionPointRequest(int id = default, string request = default, IdArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as RemoveActionPointRequest);
        }
