...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class HandTeachingModeRequest : IEquatable<HandTeachingModeRequest>, IValidatableObject
    {
        ...
        public HandTeachingModeRequest(int id = default, string request = default, HandTeachingModeRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as HandTeachingModeRequest);
        }
