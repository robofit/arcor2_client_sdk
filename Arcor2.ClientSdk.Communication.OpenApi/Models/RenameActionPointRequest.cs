...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RenameActionPointRequest : IEquatable<RenameActionPointRequest>, IValidatableObject
    {
        ...
        public RenameActionPointRequest(int id = default, string request = default, RenameActionPointRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as RenameActionPointRequest);
        }
