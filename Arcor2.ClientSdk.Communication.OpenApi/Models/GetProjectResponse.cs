...
{
    /// <summary>
    /// Response(id: int &#x3D; 0, result: bool &#x3D; True, messages: Optional[list[str]] &#x3D; None, data: Optional[arcor2.data.common.Project] &#x3D; None)
    /// </summary>
    [DataContract(Name = "GetProjectResponse")]
    public partial class GetProjectResponse : IEquatable<GetProjectResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetProjectResponse(int id = 0, string response = default, bool result = true, List<string> messages = default, Project data = default)
        {
            // to ensure "response" is required (not null)
            if (response == null)
            {
                throw new ArgumentNullException("response is a required property for GetProjectResponse and cannot be null");
            }
            Response = response;
            Id = id;
            Result = result;
        ...
        {
            return Equals(input as GetProjectResponse);
        }
