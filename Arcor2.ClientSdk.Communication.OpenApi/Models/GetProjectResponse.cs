...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class GetProjectResponse : IEquatable<GetProjectResponse>, IValidatableObject
    {
        ...
        public GetProjectResponse(int id = 0, string response = default(string), bool result = true, List<string> messages = default(List<string>), Project data = default(Project))
        {
