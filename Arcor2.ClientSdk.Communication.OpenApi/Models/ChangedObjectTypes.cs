...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ChangedObjectTypes : IEquatable<ChangedObjectTypes>, IValidatableObject
    {
        ...
        public ChangedObjectTypes(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, List<ObjectTypeMeta> data = default)
        {
        ...
        {
            return Equals(input as ChangedObjectTypes);
        }
