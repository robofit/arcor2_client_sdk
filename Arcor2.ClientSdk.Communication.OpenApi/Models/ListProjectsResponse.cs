...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ListProjectsResponse : IEquatable<ListProjectsResponse>, IValidatableObject
    {
        ...
        public ListProjectsResponse(int id = 0, string response = default, bool result = true, List<string> messages = default, List<ListProjectsResponseData> data = default)
        {
        ...
        {
            return Equals(input as ListProjectsResponse);
        }
