...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class DeleteProjectResponse : IEquatable<DeleteProjectResponse>, IValidatableObject
    {
        ...
        public DeleteProjectResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as DeleteProjectResponse);
        }
