...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class BareScene : IEquatable<BareScene>, IValidatableObject
    {
        ...
        public BareScene(string name = default, string description = @"", DateTime created = default, DateTime modified = default, DateTime intModified = default, string id = @"")
        {
        ...
        {
            return Equals(input as BareScene);
        }
