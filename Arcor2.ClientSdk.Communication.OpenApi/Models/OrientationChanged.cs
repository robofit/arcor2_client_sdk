...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class OrientationChanged : IEquatable<OrientationChanged>, IValidatableObject
    {
        ...
        public OrientationChanged(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, NamedOrientation data = default)
        {
        ...
        {
            return Equals(input as OrientationChanged);
        }
