...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RobotMoveToActionPointJoints : IEquatable<RobotMoveToActionPointJoints>, IValidatableObject
    {
        ...
        public RobotMoveToActionPointJoints(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, RobotMoveToActionPointJointsData data = default)
        {
        ...
        {
            return Equals(input as RobotMoveToActionPointJoints);
        }
