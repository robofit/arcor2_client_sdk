...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionChanged : IEquatable<ActionChanged>, IValidatableObject
    {
        ...
        public ActionChanged(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, BareAction data = default)
        {
        ...
        {
            return Equals(input as ActionChanged);
        }
