...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionParamValuesResponse : IEquatable<ActionParamValuesResponse>, IValidatableObject
    {
        ...
        public ActionParamValuesResponse(int id = 0, string response = default, bool result = true, List<string> messages = default, List<string> data = default)
        {
        ...
        {
            return Equals(input as ActionParamValuesResponse);
        }
