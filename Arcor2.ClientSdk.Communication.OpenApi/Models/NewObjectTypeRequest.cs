...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class NewObjectTypeRequest : IEquatable<NewObjectTypeRequest>, IValidatableObject
    {
        ...
        public NewObjectTypeRequest(int id = default, string request = default, ObjectTypeMeta args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as NewObjectTypeRequest);
        }
