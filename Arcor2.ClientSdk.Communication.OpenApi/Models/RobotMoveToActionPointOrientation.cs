...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RobotMoveToActionPointOrientation : IEquatable<RobotMoveToActionPointOrientation>, IValidatableObject
    {
        ...
        public RobotMoveToActionPointOrientation(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, RobotMoveToActionPointOrientationData data = default)
        {
        ...
        {
            return Equals(input as RobotMoveToActionPointOrientation);
        }
