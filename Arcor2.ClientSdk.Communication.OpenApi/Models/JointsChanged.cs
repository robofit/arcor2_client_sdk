...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class JointsChanged : IEquatable<JointsChanged>, IValidatableObject
    {
        ...
        public JointsChanged(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ProjectRobotJoints data = default)
        {
        ...
        {
            return Equals(input as JointsChanged);
        }
