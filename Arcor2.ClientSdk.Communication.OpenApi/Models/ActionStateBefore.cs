...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionStateBefore : IEquatable<ActionStateBefore>, IValidatableObject
    {
        ...
        public ActionStateBefore(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ActionStateBeforeData data = default)
        {
        ...
        {
            return Equals(input as ActionStateBefore);
        }
