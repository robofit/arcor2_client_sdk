...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddActionRequest : IEquatable<AddActionRequest>, IValidatableObject
    {
        ...
        public AddActionRequest(int id = default, string request = default, AddActionRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as AddActionRequest);
        }
