...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CalibrateRobotResponse : IEquatable<CalibrateRobotResponse>, IValidatableObject
    {
        ...
        public CalibrateRobotResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as CalibrateRobotResponse);
        }
