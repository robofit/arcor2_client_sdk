...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class PackageChanged : IEquatable<PackageChanged>, IValidatableObject
    {
        ...
        public PackageChanged(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, PackageSummary data = default)
        {
        ...
        {
            return Equals(input as PackageChanged);
        }
