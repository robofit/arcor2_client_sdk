...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ProjectException : IEquatable<ProjectException>, IValidatableObject
    {
        ...
        public ProjectException(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ProjectExceptionData data = default)
        {
        ...
        {
            return Equals(input as ProjectException);
        }
