...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RobotEef : IEquatable<RobotEef>, IValidatableObject
    {
        ...
        public RobotEef(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, RobotEefData data = default)
        {
        ...
        {
            return Equals(input as RobotEef);
        }
