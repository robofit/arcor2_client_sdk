...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionStateAfter : IEquatable<ActionStateAfter>, IValidatableObject
    {
        ...
        public ActionStateAfter(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ActionStateAfterData data = default)
        {
        ...
        {
            return Equals(input as ActionStateAfter);
        }
