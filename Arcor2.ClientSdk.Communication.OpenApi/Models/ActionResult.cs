...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionResult : IEquatable<ActionResult>, IValidatableObject
    {
        ...
        public ActionResult(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ActionResultData data = default)
        {
        ...
        {
            return Equals(input as ActionResult);
        }
