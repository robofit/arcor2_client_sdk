...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ActionCancelled : IEquatable<ActionCancelled>, IValidatableObject
    {
        ...
        public ActionCancelled(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string))
        {
        ...
        {
            return this.Equals(input as ActionCancelled);
        }
