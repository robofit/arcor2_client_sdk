...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class CopyActionPointResponse : IEquatable<CopyActionPointResponse>, IValidatableObject
    {
        ...
        public CopyActionPointResponse(int id = 0, string response = default, bool result = true, List<string> messages = default)
        {
        ...
        {
            return Equals(input as CopyActionPointResponse);
        }
