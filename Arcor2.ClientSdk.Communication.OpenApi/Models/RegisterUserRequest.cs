...
{
    /// <summary>
    /// Request(id: int, args: arcor2_arserver_data.rpc.user.RegisterUser.Request.Args)
    /// </summary>
    ...
    public partial class RegisterUserRequest : IEquatable<RegisterUserRequest>, IValidatableObject
    {
        ...
        public RegisterUserRequest(int id = default, string request = default, RegisterUserRequestArgs args = default)
        {
            Id = id;
            // to ensure "request" is required (not null)
            if (request == null)
            {
                throw new ArgumentNullException("request is a required property for RegisterUserRequest and cannot be null");
            }
            Request = request;
            // to ensure "args" is required (not null)
            if (args == null)
            {
                throw new ArgumentNullException("args is a required property for RegisterUserRequest and cannot be null");
            }
            Args = args;
        }
        ...
        public RegisterUserRequestArgs Args { get; set; }
        ...
        {
            return Equals(input as RegisterUserRequest);
        }
