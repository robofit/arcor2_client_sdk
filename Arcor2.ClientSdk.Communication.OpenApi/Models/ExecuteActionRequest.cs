...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ExecuteActionRequest : IEquatable<ExecuteActionRequest>, IValidatableObject
    {
        ...
        public ExecuteActionRequest(int id = default, string request = default, ExecuteActionRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as ExecuteActionRequest);
        }
