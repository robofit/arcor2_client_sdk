...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ProjectClosed : IEquatable<ProjectClosed>, IValidatableObject
    {
        ...
        public ProjectClosed(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string))
        {
        ...
        {
            return this.Equals(input as ProjectClosed);
        }
