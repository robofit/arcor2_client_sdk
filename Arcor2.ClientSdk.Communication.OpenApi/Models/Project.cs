...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class Project : IEquatable<Project>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Logic: ").Append(LogicItems).Append("\n");
        ...
        public bool Equals(Project input)
        {
            ...
            return 
                ...
                (
                    LogicItems == input.LogicItems ||
                    (LogicItems != null &&
                     input.LogicItems != null &&
                     LogicItems.SequenceEqual(input.LogicItems))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (LogicItems != null)
                {
                    hashCode = hashCode * 59 + LogicItems.GetHashCode();
                }
