...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class DeleteOverrideRequest : IEquatable<DeleteOverrideRequest>, IValidatableObject
    {
        ...
        public DeleteOverrideRequest(int id = default, string request = default, DeleteOverrideRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as DeleteOverrideRequest);
        }
