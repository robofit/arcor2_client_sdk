...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ProcessState : IEquatable<ProcessState>, IValidatableObject
    {
        ...
        public ProcessState(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, ProcessStateData data = default)
        {
        ...
        {
            return Equals(input as ProcessState);
        }
