...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "ProcessState")]
    public partial class ProcessState : IEquatable<ProcessState>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        public ProcessState(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), ProcessStateData data = default(ProcessStateData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for ProcessState and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ProcessState and cannot be null");
            }
            this.Data = data;
        ...
        {
            return this.Equals(input as ProcessState);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ProcessState input)
        {
            if (input == null)
            {
                return false;
