...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddLogicItemRequest : IEquatable<AddLogicItemRequest>, IValidatableObject
    {
        ...
        public AddLogicItemRequest(int id = default, string request = default, AddLogicItemRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as AddLogicItemRequest);
        }
