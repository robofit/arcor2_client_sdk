...
{
    /// <summary>
    /// Data(name: &#39;str&#39;, scene_id: &#39;str&#39;, description: &#39;str&#39; &#x3D; &lt;factory&gt;, has_logic: &#39;bool&#39; &#x3D; True, created: &#39;Optional[datetime]&#39; &#x3D; None, modified: &#39;Optional[datetime]&#39; &#x3D; None, int_modified: &#39;Optional[datetime]&#39; &#x3D; None, id: &#39;str&#39; &#x3D; &#39;&#39;, problems: Optional[list[str]] &#x3D; None)
    /// </summary>
    [DataContract(Name = "ListProjectsResponseData")]
    public partial class ListProjectsResponseData : IEquatable<ListProjectsResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListProjectsResponseData" /> class.
        /// </summary>
        [JsonConstructor]
        protected ListProjectsResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListProjectsResponseData" /> class.
        /// </summary>
        ...
        public ListProjectsResponseData(string name = default, string sceneId = default, string description = @"", bool hasLogic = true, DateTime created = default, DateTime modified = default, DateTime intModified = default, string id = @"", List<string> problems = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ListProjectsResponseData and cannot be null");
            }
            Name = name;
            // to ensure "sceneId" is required (not null)
            if (sceneId == null)
            {
                throw new ArgumentNullException("sceneId is a required property for ListProjectsResponseData and cannot be null");
            }
            SceneId = sceneId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListProjectsResponseData {\n");
        ...
        {
            return Equals(input as ListProjectsResponseData);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ListProjectsResponseData input)
        {
            if (input == null)
            {
                return false;
