...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class RenameProjectRequest : IEquatable<RenameProjectRequest>, IValidatableObject
    {
        ...
        public RenameProjectRequest(int id = default, string request = default, RenameProjectRequestArgs args = default, bool dryRun = false)
        {
            Id = id;
        ...
        {
            return Equals(input as RenameProjectRequest);
        }
