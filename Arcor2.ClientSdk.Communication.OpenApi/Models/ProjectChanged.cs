...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ProjectChanged : IEquatable<ProjectChanged>, IValidatableObject
    {
        ...
        public ProjectChanged(string varEvent = default, ChangeTypeEnum? changeType = default, string parentId = default, BareProject data = default)
        {
        ...
        {
            return Equals(input as ProjectChanged);
        }
