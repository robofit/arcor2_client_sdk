...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectChanged")]
    public partial class ProjectChanged : IEquatable<ProjectChanged>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectChanged" /> class.
        /// </summary>
        ...
        public ProjectChanged(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), BareProject data = default(BareProject))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for ProjectChanged and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ProjectChanged and cannot be null");
            }
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectChanged {\n");
        ...
        {
            return this.Equals(input as ProjectChanged);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ProjectChanged input)
        {
            if (input == null)
            {
                return false;
