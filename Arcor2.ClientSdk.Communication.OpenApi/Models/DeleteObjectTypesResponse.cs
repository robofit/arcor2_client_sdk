...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class DeleteObjectTypesResponse : IEquatable<DeleteObjectTypesResponse>, IValidatableObject
    {
        ...
        public DeleteObjectTypesResponse(int id = 0, string response = default, bool result = true, List<string> messages = default, List<DeleteObjectTypesResponseData> data = default)
        {
        ...
        {
            return Equals(input as DeleteObjectTypesResponse);
        }
