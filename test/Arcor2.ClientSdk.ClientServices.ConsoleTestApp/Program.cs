...
internal class Program {
    ...
    public static async Task<bool> EstablishSessionAsync() {
        ...
        var name = await Task.Run(ConsoleEx.ReadLinePrefix);
    ...
    private static async Task BuildProjectTempAsync(string[] args) => await GetCurrentProject()
    ...
    private static async Task StartProjectAsync() => await GetCurrentProject().Scene.StartAsync();

    private static async Task SaveProjectAsync() => await GetCurrentProject().SaveAsync();
    ...
    private static async Task ReloadProjectsAsync() => await Session.ReloadProjectsAsync();
