...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ForwardKinematicsRequest : IEquatable<ForwardKinematicsRequest>, IValidatableObject
    {
        ...
        public ForwardKinematicsRequest(int id = default(int), string request = default(string), ForwardKinematicsRequestArgs args = default(ForwardKinematicsRequestArgs))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ForwardKinematicsRequest);
        }
