...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteProjectResponse")]
    public partial class DeleteProjectResponse : IEquatable<DeleteProjectResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteProjectResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteProjectResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteProjectResponse" /> class.
        /// </summary>
        ...
        public DeleteProjectResponse(int id = 0, string response = default(string), bool result = true, List<string> messages = default(List<string>))
        {
            // to ensure "response" is required (not null)
            if (response == null)
            {
                throw new ArgumentNullException("response is a required property for DeleteProjectResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as DeleteProjectResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteProjectResponse input)
        {
            if (input == null)
            {
                return false;
