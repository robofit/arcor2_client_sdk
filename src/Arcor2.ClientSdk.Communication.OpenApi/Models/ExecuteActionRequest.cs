...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ExecuteActionRequest : IEquatable<ExecuteActionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public ExecuteActionRequest(int id = default(int), string request = default(string), ExecuteActionRequestArgs args = default(ExecuteActionRequestArgs), bool dryRun = false)
        {
            this.Id = id;
            // to ensure "request" is required (not null)
            if (request == null)
            {
                throw new ArgumentNullException("request is a required property for ExecuteActionRequest and cannot be null");
            }
            this.Request = request;
            // to ensure "args" is required (not null)
            if (args == null)
            {
                throw new ArgumentNullException("args is a required property for ExecuteActionRequest and cannot be null");
            }
            this.Args = args;
            this.DryRun = dryRun;
        }
        ...
        public ExecuteActionRequestArgs Args { get; set; }
        ...
        {
            return this.Equals(input as ExecuteActionRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ExecuteActionRequest input)
        {
            if (input == null)
            {
                return false;
