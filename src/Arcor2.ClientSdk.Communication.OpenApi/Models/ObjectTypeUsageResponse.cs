...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ObjectTypeUsageResponse : IEquatable<ObjectTypeUsageResponse>, IValidatableObject
    {
        ...
        public ObjectTypeUsageResponse(int id = 0, string response = default(string), bool result = true, List<string> messages = default(List<string>), List<string> data = default(List<string>))
        {
        ...
        {
            return this.Equals(input as ObjectTypeUsageResponse);
        }
