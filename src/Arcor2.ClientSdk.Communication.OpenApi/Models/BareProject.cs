...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class BareProject : IEquatable<BareProject>, IValidatableObject
    {
        ...
        public BareProject(string name = default(string), string sceneId = default(string), string description = @"", bool hasLogic = true, DateTime created = default(DateTime), DateTime modified = default(DateTime), DateTime intModified = default(DateTime), string id = @"")
        {
        ...
        {
            return this.Equals(input as BareProject);
        }
