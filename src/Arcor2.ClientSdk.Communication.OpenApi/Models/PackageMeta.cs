...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class PackageMeta : IEquatable<PackageMeta>, IValidatableObject
    {
        ...
        public PackageMeta(string name = default(string), DateTime built = default(DateTime), DateTime executed = default(DateTime))
        {
        ...
        {
            return this.Equals(input as PackageMeta);
        }
