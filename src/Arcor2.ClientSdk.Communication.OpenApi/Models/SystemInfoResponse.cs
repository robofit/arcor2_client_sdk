...
{
    /// <summary>
    /// Response(id: int &#x3D; 0, result: bool &#x3D; True, messages: Optional[list[str]] &#x3D; None, data: Optional[arcor2_arserver_data.rpc.common.SystemInfo.Response.Data] &#x3D; None)
    /// </summary>
    ...
    public partial class SystemInfoResponse : IEquatable<SystemInfoResponse>, IValidatableObject
    {
        ...
        public SystemInfoResponse(int id = 0, string response = default(string), bool result = true, List<string> messages = default(List<string>), SystemInfoResponseData data = default(SystemInfoResponseData))
        {
            // to ensure "response" is required (not null)
            if (response == null)
            {
                throw new ArgumentNullException("response is a required property for SystemInfoResponse and cannot be null");
            }
        ...
        public SystemInfoResponseData Data { get; set; }
