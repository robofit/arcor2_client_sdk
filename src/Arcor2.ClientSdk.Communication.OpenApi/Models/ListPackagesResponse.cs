...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ListPackagesResponse : IEquatable<ListPackagesResponse>, IValidatableObject
    {
        ...
        public ListPackagesResponse(int id = 0, string response = default(string), bool result = true, List<string> messages = default(List<string>), List<PackageSummary> data = default(List<PackageSummary>))
        {
