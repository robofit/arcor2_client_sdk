...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectException")]
    public partial class ProjectException : IEquatable<ProjectException>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        public ProjectException(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string), ProjectExceptionData data = default(ProjectExceptionData))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for ProjectException and cannot be null");
            }
            this.Event = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ProjectException and cannot be null");
            }
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectException {\n");
        ...
        {
            return this.Equals(input as ProjectException);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ProjectException input)
        {
            if (input == null)
            {
                return false;
