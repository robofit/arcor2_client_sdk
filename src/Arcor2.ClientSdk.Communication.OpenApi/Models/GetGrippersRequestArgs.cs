...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "GetGrippersRequestArgs")]
    public partial class GetGrippersRequestArgs : IEquatable<GetGrippersRequestArgs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGrippersRequestArgs" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetGrippersRequestArgs() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGrippersRequestArgs" /> class.
        /// </summary>
        /// <param name="robotId">robotId (required).</param>
        /// <param name="armId">armId.</param>
        public GetGrippersRequestArgs(string robotId = default(string), string armId = default(string))
        {
            // to ensure "robotId" is required (not null)
            if (robotId == null)
            {
                throw new ArgumentNullException("robotId is a required property for GetGrippersRequestArgs and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetGrippersRequestArgs {\n");
        ...
        {
            return this.Equals(input as GetGrippersRequestArgs);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetGrippersRequestArgs input)
        {
            if (input == null)
            {
                return false;
