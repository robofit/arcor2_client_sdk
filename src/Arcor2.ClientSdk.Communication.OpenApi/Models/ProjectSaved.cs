...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// ProjectSaved()
    /// </summary>
    [DataContract(Name = "ProjectSaved")]
    public partial class ProjectSaved : IEquatable<ProjectSaved>, IValidatableObject
    {
        /// <summary>
        /// Defines ChangeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSaved" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectSaved() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSaved" /> class.
        /// </summary>
        ...
        public ProjectSaved(string varEvent = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), string parentId = default(string))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for ProjectSaved and cannot be null");
            }
            this.Event = varEvent;
        ...
        {
            return this.Equals(input as ProjectSaved);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSaved input)
        {
            if (input == null)
            {
                return false;
