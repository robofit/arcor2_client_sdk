...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class ListProjectsResponseData : IEquatable<ListProjectsResponseData>, IValidatableObject
    {
        ...
        public ListProjectsResponseData(string name = default(string), string sceneId = default(string), string description = @"", bool hasLogic = true, DateTime created = default(DateTime), DateTime modified = default(DateTime), DateTime intModified = default(DateTime), string id = @"", List<string> problems = default(List<string>))
        {
        ...
        {
            return this.Equals(input as ListProjectsResponseData);
        }
