...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "CopyProjectRequest")]
    public partial class CopyProjectRequest : IEquatable<CopyProjectRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CopyProjectRequest" /> class.
        /// </summary>
        ...
        public CopyProjectRequest(int id = default(int), string request = default(string), CopyProjectRequestArgs args = default(CopyProjectRequestArgs), bool dryRun = false)
        {
            this.Id = id;
            // to ensure "request" is required (not null)
            if (request == null)
            {
                throw new ArgumentNullException("request is a required property for CopyProjectRequest and cannot be null");
            }
            this.Request = request;
            // to ensure "args" is required (not null)
            if (args == null)
            {
                throw new ArgumentNullException("args is a required property for CopyProjectRequest and cannot be null");
            }
            this.Args = args;
            this.DryRun = dryRun;
        }
        ...
        public CopyProjectRequestArgs Args { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CopyProjectRequest {\n");
        ...
        {
            return this.Equals(input as CopyProjectRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CopyProjectRequest input)
        {
            if (input == null)
            {
                return false;
