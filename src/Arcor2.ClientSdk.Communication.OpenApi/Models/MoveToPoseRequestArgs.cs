...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class MoveToPoseRequestArgs : IEquatable<MoveToPoseRequestArgs>, IValidatableObject
    {
        ...
        public MoveToPoseRequestArgs(string robotId = default(string), string endEffectorId = default(string), decimal speed = default(decimal), Position position = default(Position), Orientation orientation = default(Orientation), bool safe = true, bool linear = false, string armId = default(string))
        {
        ...
        {
            return this.Equals(input as MoveToPoseRequestArgs);
        }
