...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    /// </summary>
    [DataContract(Name = "NewProjectRequest")]
    public partial class NewProjectRequest : IEquatable<NewProjectRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewProjectRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewProjectRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewProjectRequest" /> class.
        /// </summary>
        ...
        public NewProjectRequest(int id = default(int), string request = default(string), NewProjectRequestArgs args = default(NewProjectRequestArgs), bool dryRun = false)
        {
            this.Id = id;
            // to ensure "request" is required (not null)
            if (request == null)
            {
                throw new ArgumentNullException("request is a required property for NewProjectRequest and cannot be null");
            }
            this.Request = request;
            // to ensure "args" is required (not null)
            if (args == null)
            {
                throw new ArgumentNullException("args is a required property for NewProjectRequest and cannot be null");
            }
            this.Args = args;
            this.DryRun = dryRun;
        }
        ...
        public NewProjectRequestArgs Args { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewProjectRequest {\n");
        ...
        {
            return this.Equals(input as NewProjectRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(NewProjectRequest input)
        {
            if (input == null)
            {
                return false;
