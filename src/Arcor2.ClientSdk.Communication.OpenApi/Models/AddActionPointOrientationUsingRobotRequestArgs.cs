...
namespace Arcor2.ClientSdk.Communication.OpenApi.Models
{
    ...
    public partial class AddActionPointOrientationUsingRobotRequestArgs : IEquatable<AddActionPointOrientationUsingRobotRequestArgs>, IValidatableObject
    {
        ...
        public AddActionPointOrientationUsingRobotRequestArgs(string actionPointId = default(string), RobotArg robot = default(RobotArg), string name = @"default")
        {
        ...
        {
            return this.Equals(input as AddActionPointOrientationUsingRobotRequestArgs);
        }
