...
namespace Arcor2.ClientSdk.ClientServices.Extensions {
    public static class ParameterMetaExtensions {
        /// <summary>
        ///     Creates a new parameter from parameter metadata using the default value. If no default value is defined, uses empty
        ///     string.
        /// </summary>
        /// <param name="meta">The parameter meta.</param>
        public static Parameter ToParameter(this ParameterMeta meta) =>
            new Parameter(meta.Name, meta.Type, meta.DefaultValue ?? "");
        ...
        public static Parameter ToParameter(this ParameterMeta meta, string value) =>
            new Parameter(meta.Name, meta.Type, value);
        ...
        /// </summary>
        /// <param name="meta">The parameter meta.</param>
        public static ActionParameter ToActionParameter(this ParameterMeta meta) =>
            new ActionParameter(meta.Name, meta.Type, meta.DefaultValue ?? "");
        ...
        /// <param name="meta">The parameter meta.</param>
        /// <param name="value">The string representation of the value.</param>
        public static ActionParameter ToActionParameter(this ParameterMeta meta, string value) =>
            new ActionParameter(meta.Name, meta.Type, value);
