namespace Arcor2.ClientSdk.ClientServices.Enums {
    ...
    public enum NavigationState {
        ...
        /// </summary>
        /// <remarks>
        ///     The distinction of what type of object should the menu list is purely informational. There are no restrictions on
        ///     available RPCs, event, or other behavior.
        ...
        /// </summary>
        /// <remarks>
        ///     This state can be either be ignored or a loading screen can be shown. One of the menu states usually quickly
        ///     follows.
        /// </remarks>
        SceneClosed,
    ...
    public static class NavigationStateExtensions {
        ...
        public static bool IsInMenu(this NavigationState state) =>
            state == NavigationState.MenuListOfScenes ||
