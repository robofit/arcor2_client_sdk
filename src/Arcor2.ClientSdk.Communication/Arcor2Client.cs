    ...
    public class Arcor2Client {
        ...
        private void OnMessage(WebSocketMessageEventArgs args) {
            try {
                ...
                var dispatch = JsonConvert.DeserializeAnonymousType(data,
                    new {
                        id = (int?) default,
                ...
                if(dispatch.response != null && dispatch.id != null && dispatch.id != 0) {
                    if(pendingRequests.TryGetValue(dispatch.id.Value, out var pendingRequest)) {
        ...
        private class PendingRequest {
            public PendingRequest(uint timeout, string signature) {
                ...
                CancellationTokenSource.Token.Register(() => {
                    TaskCompletionSource.TrySetException(new Arcor2ConnectionException(
                        "A pending ARCOR2 request failed.", new TimeoutException("The request timed out.")));
                }, false);
            }
        ...
        ///     scene - for that see <see cref="ActionObjectAdded" /> and related events.
        ///     This event is rather used for signaling dynamic changes to the object type database (such as is the case with
        ///     virtual objects <see cref="AddVirtualCollisionObjectToSceneAsync" />).
        /// </remarks>
        ...
        private async Task<string> SendAndWaitAsync<T>(T message, int id, string rpcSignature) =>
            await SendAndWaitAsync(JsonConvert.SerializeObject(message), id, rpcSignature);
        ...
        private void HandleOverrideUpdated(string data) {
            ...
            switch(overrideUpdated.ChangeType) {
                case OverrideUpdated.ChangeTypeEnum.Add:
                    ProjectOverrideAdded?.Invoke(this,
                        new ParameterEventArgs(overrideUpdated.Data, overrideUpdated.ParentId));
                    break;
                case OverrideUpdated.ChangeTypeEnum.Remove:
                    ProjectOverrideRemoved?.Invoke(this,
                        new ParameterEventArgs(overrideUpdated.Data, overrideUpdated.ParentId));
                    break;
                case OverrideUpdated.ChangeTypeEnum.Update:
                    ProjectOverrideUpdated?.Invoke(this,
                        new ParameterEventArgs(overrideUpdated.Data, overrideUpdated.ParentId));
                    break;
        ...
        private void HandleOrientationChanged(string data) {
            ...
            switch(orientationChanged.ChangeType) {
                case OrientationChanged.ChangeTypeEnum.Add:
                    OrientationAdded?.Invoke(this,
                        new OrientationEventArgs(orientationChanged.Data, orientationChanged.ParentId));
                    break;
        ...
        private void HandleRobotMoveToActionPointOrientation(string data) {
            var robotMoveToActionPointOrientation =
                JsonConvert.DeserializeObject<RobotMoveToActionPointOrientation>(data, jsonSettings)!;
            RobotMoveToActionPointOrientation?.Invoke(this,
                new RobotMoveToActionPointOrientationEventArgs(robotMoveToActionPointOrientation.Data));
        }
        ...
        private void HandleRobotMoveToActionPointJoints(string data) {
            var robotMoveToActionPointJoints =
                JsonConvert.DeserializeObject<RobotMoveToActionPointJoints>(data, jsonSettings)!;
            RobotMoveToActionPointJoints?.Invoke(this,
                new RobotMoveToActionPointJointsEventArgs(robotMoveToActionPointJoints.Data));
        }
        ...
        public async Task<DeleteObjectTypesResponse> RemoveObjectTypeAsync(string args, bool isDryRun = false) {
            ...
            var response =
                await SendAndWaitAsync(
                    new DeleteObjectTypesRequest(id, "DeleteObjectTypes", new List<string> { args }, isDryRun), id,
                    "DeleteObjectTypes");
        ...
        public async Task<DeleteObjectTypesResponse> RemoveObjectTypesAsync(List<string> args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new DeleteObjectTypesRequest(id, "DeleteObjectTypes", args, isDryRun),
                id, "DeleteObjectTypes");
            return JsonConvert.DeserializeObject<DeleteObjectTypesResponse>(response, jsonSettings)!;
        }
        ...
        public async Task<GetObjectTypesResponse> GetObjectTypesAsync() {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new GetObjectTypesRequest(id, "GetObjectTypes"), id, "GetObjectTypes");
        ...
        public async Task<SaveProjectResponse> SaveProjectAsync(bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new SaveProjectRequest(id, "SaveProject", isDryRun), id, "SaveProject");
        ...
        public async Task<UploadPackageResponse> UploadPackageAsync(UploadPackageRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UploadPackageRequest(id, "UploadPackage", args), id, "UploadPackage");
        ...
        public async Task<RenamePackageResponse> RenamePackageAsync(RenamePackageRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new RenamePackageRequest(id, "RenamePackage", args), id, "RenamePackage");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointUsingRobotResponse> UpdateActionPointUsingRobotAsync(
            UpdateActionPointUsingRobotRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UpdateActionPointUsingRobotRequest(id, "UpdateActionPointUsingRobot", args),
                    id, "UpdateActionPointUsingRobot");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateObjectPoseResponse> UpdateActionObjectPoseAsync(UpdateObjectPoseRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new UpdateObjectPoseRequest(id, "UpdateObjectPose", args, isDryRun),
                id, "UpdateObjectPose");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateObjectPoseUsingRobotResponse> UpdateObjectPoseUsingRobotAsync(
            UpdateObjectPoseUsingRobotRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UpdateObjectPoseUsingRobotRequest(id, "UpdateObjectPoseUsingRobot", args),
                    id, "UpdateObjectPoseUsingRobot");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<ObjectAimingStartResponse> ObjectAimingStartAsync(ObjectAimingStartRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new ObjectAimingStartRequest(id, "ObjectAimingStart", args, isDryRun),
                id, "ObjectAimingStart");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<ObjectAimingAddPointResponse> ObjectAimingAddPointAsync(ObjectAimingAddPointRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new ObjectAimingAddPointRequest(id, "ObjectAimingAddPoint", args, isDryRun), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddObjectToSceneResponse> AddActionObjectToSceneAsync(AddObjectToSceneRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new AddObjectToSceneRequest(id, "AddObjectToScene", args, isDryRun),
                id, "AddObjectToScene");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RemoveFromSceneResponse> RemoveActionObjectFromSceneAsync(RemoveFromSceneRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<ExecuteActionResponse> ExecuteActionAsync(ExecuteActionRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        public async Task<BuildProjectResponse> BuildProjectAsync(BuildProjectRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new BuildProjectRequest(id, "BuildProject", args), id, "BuildProject");
        ...
        public async Task<DeleteProjectResponse> RemoveProjectAsync(IdArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new DeleteProjectRequest(id, "DeleteProject", args), id, "DeleteProject");
        ...
        public async Task<DeletePackageResponse> RemovePackageAsync(IdArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new DeletePackageRequest(id, "DeletePackage", args), id, "DeletePackage");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddActionPointResponse> AddActionPointAsync(AddActionPointRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddApUsingRobotResponse> AddActionPointUsingRobotAsync(AddApUsingRobotRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointPositionResponse> UpdateActionPointPositionAsync(
            UpdateActionPointPositionRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new UpdateActionPointPositionRequest(id, "UpdateActionPointPosition", args, isDryRun), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointParentResponse> UpdateActionPointParentAsync(
            UpdateActionPointParentRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new UpdateActionPointParentRequest(id, "UpdateActionPointParent", args, isDryRun), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddActionPointOrientationResponse> AddActionPointOrientationAsync(
            AddActionPointOrientationRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new AddActionPointOrientationRequest(id, "AddActionPointOrientation", args, isDryRun), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RemoveActionPointOrientationResponse> RemoveActionPointOrientationAsync(
            RemoveActionPointOrientationRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new RemoveActionPointOrientationRequest(id, "RemoveActionPointOrientation", args, isDryRun), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointOrientationResponse> UpdateActionPointOrientationAsync(
            UpdateActionPointOrientationRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new UpdateActionPointOrientationRequest(id, "UpdateActionPointOrientation", args), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddActionPointOrientationUsingRobotResponse> AddActionPointOrientationUsingRobotAsync(
            AddActionPointOrientationUsingRobotRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new AddActionPointOrientationUsingRobotRequest(id, "AddActionPointOrientationUsingRobot", args,
                        isDryRun), id, "AddActionPointOrientationUsingRobot");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointOrientationUsingRobotResponse> UpdateActionPointOrientationUsingRobotAsync(
            UpdateActionPointOrientationUsingRobotRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new UpdateActionPointOrientationUsingRobotRequest(id, "UpdateActionPointOrientationUsingRobot",
                        args), id, "UpdateActionPointOrientationUsingRobot");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddActionPointJointsUsingRobotResponse> AddActionPointJointsUsingRobotAsync(
            AddActionPointJointsUsingRobotRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new AddActionPointJointsUsingRobotRequest(id, "AddActionPointJointsUsingRobot", args, isDryRun), id,
                    "AddActionPointJointsUsingRobot");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointJointsResponse> UpdateActionPointJointsAsync(
            UpdateActionPointJointsRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UpdateActionPointJointsRequest(id, "UpdateActionPointJoints", args), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateActionPointJointsUsingRobotResponse> UpdateActionPointJointsUsingRobotAsync(
            UpdateActionPointJointsUsingRobotRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new UpdateActionPointJointsUsingRobotRequest(id, "UpdateActionPointJointsUsingRobot", args), id,
                    "UpdateActionPointJointsUsingRobot");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RenameActionPointResponse> RenameActionPointAsync(RenameActionPointRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new RenameActionPointRequest(id, "RenameActionPoint", args, isDryRun),
                id, "RenameActionPoint");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RenameActionPointJointsResponse> RenameActionPointJointsAsync(
            RenameActionPointJointsRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new RenameActionPointJointsRequest(id, "RenameActionPointJoints", args, isDryRun), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RenameActionPointOrientationResponse> RenameActionPointOrientationAsync(
            RenameActionPointOrientationRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new RenameActionPointOrientationRequest(id, "RenameActionPointOrientation", args, isDryRun), id,
                    "RenameActionPointOrientation");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RemoveActionPointJointsResponse> RemoveActionPointJointsAsync(
            RemoveActionPointJointsRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new RemoveActionPointJointsRequest(id, "RemoveActionPointJoints", args), id,
        ...
        public async Task<AddActionResponse> AddActionAsync(AddActionRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new AddActionRequest(id, "AddAction", args, isDryRun), id, "AddAction");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateLogicItemResponse> UpdateLogicItemAsync(UpdateLogicItemRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RenameProjectResponse> RenameProjectAsync(RenameProjectRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        public async Task<RemoveActionPointResponse> RemoveActionPointAsync(IdArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new RemoveActionPointRequest(id, "RemoveActionPoint", args, isDryRun),
                id, "RemoveActionPoint");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RegisterForRobotEventResponse> RegisterForRobotEventAsync(
            RegisterForRobotEventRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new RegisterForRobotEventRequest(id, "RegisterForRobotEvent", args),
                id, "RegisterForRobotEvent");
        ...
        public async Task<GetRobotArmsResponse> GetRobotArmsAsync(GetRobotArmsRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new GetRobotArmsRequest(id, "GetRobotArms", args), id, "GetRobotArms");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateObjectParametersResponse> UpdateActionObjectParametersAsync(
            UpdateObjectParametersRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UpdateObjectParametersRequest(id, "UpdateObjectParameters", args, isDryRun),
                    id, "UpdateObjectParameters");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateOverrideResponse> UpdateOverrideAsync(UpdateOverrideRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<DeleteOverrideResponse> RemoveOverrideAsync(DeleteOverrideRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        public async Task<GetCameraPoseResponse> GetCameraPoseAsync(GetCameraPoseRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new GetCameraPoseRequest(id, "GetCameraPose", args), id, "GetCameraPose");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<HandTeachingModeResponse> SetHandTeachingModeAsync(HandTeachingModeRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new HandTeachingModeRequest(id, "HandTeachingMode", args, isDryRun),
                id, "HandTeachingMode");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<CopyActionPointResponse> DuplicateActionPointAsync(CopyActionPointRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<StepRobotEefResponse> StepRobotEndEffectorAsync(StepRobotEefRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<SetEefPerpendicularToWorldResponse> SetEndEffectorPerpendicularToWorldAsync(
            SetEefPerpendicularToWorldRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new SetEefPerpendicularToWorldRequest(id, "SetEefPerpendicularToWorld", args, isDryRun), id,
        ...
        public async Task<RegisterUserResponse> RegisterUserAsync(RegisterUserRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new RegisterUserRequest(id, "RegisterUser", args), id, "RegisterUser");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddProjectParameterResponse> AddProjectParameterAsync(AddProjectParameterRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new AddProjectParameterRequest(id, "AddProjectParameter", args, isDryRun), id,
                    "AddProjectParameter");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateProjectParameterResponse> UpdateProjectParameterAsync(
            UpdateProjectParameterRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UpdateProjectParameterRequest(id, "UpdateProjectParameter", args, isDryRun),
                    id, "UpdateProjectParameter");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<RemoveProjectParameterResponse> RemoveProjectParameterAsync(
            RemoveProjectParameterRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new RemoveProjectParameterRequest(id, "RemoveProjectParameter", args, isDryRun),
                    id, "RemoveProjectParameter");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateObjectModelResponse> UpdateObjectTypeModelAsync(UpdateObjectModelRequestArgs args,
            bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new UpdateObjectModelRequest(id, "UpdateObjectModel", args, isDryRun),
                id, "UpdateObjectModel");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<AddVirtualCollisionObjectToSceneResponse> AddVirtualCollisionObjectToSceneAsync(
            AddVirtualCollisionObjectToSceneRequestArgs args, bool isDryRun = false) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(
                    new AddVirtualCollisionObjectToSceneRequest(id, "AddVirtualCollisionObjectToScene", args, isDryRun),
                    id, "AddVirtualCollisionObjectToScene");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<CopyProjectResponse>
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<CameraColorParametersResponse> GetCameraColorParametersAsync(
            CameraColorParametersRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new CameraColorParametersRequest(id, "CameraColorParameters", args),
                id, "CameraColorParameters");
        ...
        public async Task<MoveToJointsResponse> MoveToJointsAsync(MoveToJointsRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new MoveToJointsRequest(id, "MoveToJoints", args), id, "MoveToJoints");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateProjectDescriptionResponse> UpdateProjectDescriptionAsync(
            UpdateProjectDescriptionRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response =
                await SendAndWaitAsync(new UpdateProjectDescriptionRequest(id, "UpdateProjectDescription", args), id,
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateProjectHasLogicResponse> UpdateProjectHasLogicAsync(
            UpdateProjectHasLogicRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new UpdateProjectHasLogicRequest(id, "UpdateProjectHasLogic", args),
                id, "UpdateProjectHasLogic");
        ...
        ///     matching IDs, but mismatching RPC names).
        /// </exception>
        public async Task<UpdateSceneDescriptionResponse> UpdateSceneDescriptionAsync(
            UpdateSceneDescriptionRequestArgs args) {
            var id = Interlocked.Increment(ref requestId);
            var response = await SendAndWaitAsync(new UpdateSceneDescriptionRequest(id, "UpdateSceneDescription", args),
                id, "UpdateSceneDescription");
